...
class  EmpresaService extends AbstractService
{
    ...
    public function salvaEmpressaAssinante($dados)
    {
        ...
        $empresaValidador = new EmpresaValidador();
        /** @var EmpresaValidador $validador */
        $validador = $empresaValidador->validarEmpresa($dados);
        if ($validador[SUCESSO]) {
            ...
            $this->Salva($empresa, $assinante->getCoEmpresa()->getCoEmpresa());
