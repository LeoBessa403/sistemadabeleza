...
class StatusAgendaEntidade extends AbstractEntidade
{
	...
	private $st_status;
	private $dt_agenda;
	private $nu_hora_inicio_agenda;
	private $nu_hora_fim_agenda;
	private $nu_valor;
	private $nu_duracao;
    ...
    */
    ...
    {
        return $this->dt_agenda = $dt_agenda;
    }

	/**
	* @return mixed $nu_hora_inicio_agenda
    */
	public function getNuHoraInicioAgenda()
    {
        return $this->nu_hora_inicio_agenda;
    }

	/**
	* @param $nu_hora_inicio_agenda
    * @return mixed
    */
	public function setNuHoraInicioAgenda($nu_hora_inicio_agenda)
    {
        return $this->nu_hora_inicio_agenda = $nu_hora_inicio_agenda;
    }

	/**
	* @return mixed $nu_hora_fim_agenda
    */
	public function getNuHoraFimAgenda()
    {
        return $this->nu_hora_fim_agenda;
    }
