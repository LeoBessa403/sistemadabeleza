                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="<?= HOME . ADMIN . "/" . UrlAmigavel::$controller . "/" . UrlAmigavel::$action; ?>"
                              ...
                              id="CadastroProfissional" name="CadastroProfissional">
                            <div id="wizard" class="swMain">
                                <ul>
                                    <li>
                                        <a href="#step-1" class="selected">
                                            <div class="stepNumber">1</div>
                                            <span class="stepDesc"> Profissonal<br/>
                                    ...
                                    <li>
                                        <a href="#step-4">
                                            ...
                                            <span class="stepDesc"> Informações<br/>
												<small>Informações do profissional</small>
                                            </span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#step-5">
                                            ...
                                            <span class="stepDesc"> Conta Bancária<br/>
                                ...
                                <div id="step-1">
                                    <h2 class="StepTitle">Profissonal
                                        <small>Informações básicas</small>
                                    </h2>
                                    ...
                                    <div class="form-group">
                                        <label for="<?= NO_APELIDO; ?>" class="col-sm-3 control-label">
                                            Apelido
                                        </label>
                                        <div class="col-sm-7">
                                            <input type="text" class="form-control" id="<?= NO_APELIDO; ?>"
                                                   name="<?= NO_APELIDO; ?>"
                                                   value="<?= $assinanteEdit->getCoPessoa()->getNoPessoa(); ?>"
                                    ...
                                    <div id="step-4">
                                        <h2 class="StepTitle"> Informações
                                            <small>Informações do profissional</small>
                                        </h2>
                                        <?php
                                    ...
                                    <div id="step-5">
                                        <h2 class="StepTitle">Conta Bancária
                                            <small>Dados bancários</small>
                                        </h2>
                                        <?php
