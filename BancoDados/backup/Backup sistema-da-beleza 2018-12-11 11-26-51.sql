...
CREATE TABLE `tb_profissional` (
  ...
  `co_jornada_trabalho` int(11) NOT NULL,
  PRIMARY KEY (`co_profissional`,`co_imagem`,`co_pessoa`,`co_usuario`,`co_assinante`,`co_conta_bancaria`,`co_jornada_trabalho`),
  ...
  KEY `fk_TB_PROFISSIONAL_TB_JORNADA_TRABALHO1_idx` (`co_jornada_trabalho`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
